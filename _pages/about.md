...
I went on to complete an MSc in Biology at Georgia State University in Atlanta, Georgia, focusing on microbiome research and host–microbiome interactions with [Dr Kuk-Jeong Chin](https://cas.gsu.edu/profile/kuk-jeong-chin/). This phase of my training provided hands-on experimental experience with microbial systems, molecular techniques, bioinformatics, and it played a key role in preparing me to move into my career in biological research.

In 2021, I joined the [Ratcliff lab](https://ratclifflab.biosci.gatech.edu/) led by [Dr. William Ratcliff](https://biosciences.gatech.edu/people/will-ratcliff) at Georgia Institute of Technology in Atlanta, Georgia, where I became involved in long-term evolution experiments exploring the origins of multicellularity. I progressed from Research Technician to Research Scientist I, and my current work integrates experimental evolution and systems-level approaches to explore epigenetic mechanisms of multicellular adaptation in order to understand how biological complexity arises and persists over evolutionary time.
